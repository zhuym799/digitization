...
BOOL VerifyEmbeddedSignature( LPCWSTR pwszSourceFile )
{
  ...
  */
    ...
    case TRUST_E_NOSIGNATURE:
      {
         ...
         || dwLastError == TRUST_E_PROVIDER_UNKNOWN )
        {
          ...
          if(IDYES==::MessageBox( NULL, _T("The TWAIN DSM is not signed.\nContinue to load this DSM?"), _T("The TWAIN DSM Signature"), MB_YESNO|MB_ICONQUESTION))
          {
        ...
        NULL ))
  {
    ...
    {
      HWND hWnd = NULL;
      ::MessageBox( hWnd, (LPCTSTR)lpMsgBuf, _T("signature"), MB_OK|MB_ICONEXCLAMATION);
    }
    // Free the buffer.
    LocalFree( lpMsgBuf );
  }
